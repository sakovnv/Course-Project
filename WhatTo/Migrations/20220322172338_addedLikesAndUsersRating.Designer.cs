...
namespace Project.Migrations
{
    ...
    [Migration("20220322172338_addedLikesAndUsersRating")]
    partial class addedLikesAndUsersRating
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.Models.UsersRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Project.Models.Like", b =>
                {
                    b.HasOne("Project.Models.User", "LikedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Project.Models.UsersRating", b =>
                {
                    b.HasOne("Project.Models.User", "RatedUser")
                        .WithMany()
                        .HasForeignKey("RatedUserId");

                    b.HasOne("Project.Models.Review", null)
                        .WithMany("OverallRating")
                        .HasForeignKey("ReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
